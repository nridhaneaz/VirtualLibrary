                ...
                delete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        else
                        {
                            ...
                            String url="https://rafiul1410963303.000webhostapp.com/app/confirmDeleteAccount.php?un="+MainActivity.Username+"&ps="+password;
...
//            startActivity(new Intent(getContext(),LoginSignup.class));
    ...
    private void deleteAccount()
    {
        ...
        String url="https://rafiul1410963303.000webhostapp.com/app/deleteAccount.php?uid="+userId;
        JsonObjectRequest objectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                try {
