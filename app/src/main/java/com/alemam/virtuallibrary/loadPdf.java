...
//                    heartIcon.setImageResource(R.drawable.heart_fill);
    ...
    private void checkWishlist(String catId,String bookId)
    {
        ...
        String url="https://rafiul1410963303.000webhostapp.com/app/checkWishlist.php?uid="+UserId+"&bid="+bookId+"&cid="+catId;
    ...
    {
        String UserId = MainActivity.Userid;
        String url="https://rafiul1410963303.000webhostapp.com/app/addToWishlist.php?uid="+UserId+"&bid="+bookId+"&bn="+bookName+"&cid="+catId;
