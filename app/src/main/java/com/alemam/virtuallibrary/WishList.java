                    ...
                    new AlertDialog.Builder(getActivity())
                            ...
                            .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    String url="https://rafiul1410963303.000webhostapp.com/app/removeFavBooks.php?uid="+userId+"&bid="+Id+"&cid="+cId;
...
//
    ...
    private void getData()
    {
        ...
        String url="https://rafiul1410963303.000webhostapp.com/app/getFavBooks.php?uid="+UserId;
