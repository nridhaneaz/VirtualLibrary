...
*/
        ...
        Animation LeftToRight = AnimationUtils.loadAnimation(getApplicationContext(),R.anim.up_to_down);
        iconLibrary.startAnimation(LeftToRight);

        Animation UpToDown = AnimationUtils.loadAnimation(getApplicationContext(),R.anim.up_from_bottom_slow);
