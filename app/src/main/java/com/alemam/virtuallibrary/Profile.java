...
//                            editProfile = true;
                                ...
                                String url = "https://rafiul1410963303.000webhostapp.com/app/updateProfile.php?uid=" + MainActivity.Userid + "&nm=" + nm + "&un=" + un + "&em=" + em;
...
//                            editProfile = false;
    ...
    private void getProfileDetails()
    {
        ...
        String url = "https://rafiul1410963303.000webhostapp.com/app/getProfileDetails.php?uid="+MainActivity.Userid;
        JsonObjectRequest objectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                progressBar.setVisibility(View.GONE);
